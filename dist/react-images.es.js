...
var NavigationPrev = function NavigationPrev(props) {
  ...
  return glam(
    Button,
    _extends({ css: getStyles('navigationPrev', props) }, innerProps),
    children
  );
};
...
var NavigationNext = function NavigationNext(props) {
  ...
  return glam(
    Button,
    _extends({ css: getStyles('navigationNext', props) }, innerProps),
    children
  );
};
...
export { Modal, ModalGateway, defaultCarouselComponents, defaultModalComponents };
